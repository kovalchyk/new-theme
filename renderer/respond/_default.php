...
<div id="respond" class5="uk-panel uk-panel-box uk-article-divider">
    ...
    <form class="uk-grid-small" method="post" action="<?php echo $this->app->link(array('controller' => 'comment', 'task' => 'save')); ?>" uk-grid>
        ...
        <?php $message = $registered ? JText::_('LOGIN_TO_LEAVE_COMMENT') : JText::_('You are commenting as guest.'); ?>
            <p class="user"><?php echo $message; ?> <?php if ($params->get('facebook_enable') || $params->get('twitter_enable'))
                echo JText::_('Optional login below.'); ?>
            </p>
        ...
        <?php if ($captcha): ?>
        <?php if ($this->app->jbversion->joomla('3')) {
